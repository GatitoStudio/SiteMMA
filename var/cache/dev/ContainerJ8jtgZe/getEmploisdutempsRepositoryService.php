...
// Returns the private 'App\Repository\EmploisdutempsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EmploisdutempsRepository.php';

return $this->privates['App\\Repository\\EmploisdutempsRepository'] = new \App\Repository\EmploisdutempsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
