...
// Returns the private 'App\Repository\TutoratRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TutoratRepository.php';

return $this->privates['App\\Repository\\TutoratRepository'] = new \App\Repository\TutoratRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
