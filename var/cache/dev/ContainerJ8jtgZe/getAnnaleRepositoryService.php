...
// Returns the private 'App\Repository\AnnaleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AnnaleRepository.php';

return $this->privates['App\\Repository\\AnnaleRepository'] = new \App\Repository\AnnaleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
