...
class __TwigTemplate_92881bfb435539befe14b8fbbbb2f84242f70e16542c5a110bffe698881fce05 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\" class=\"form-signin\">
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"mail\" id=\"inputMail\" class=\"form-control\" placeholder=\"Mail\" required autofocus>
...
<form method=\"post\" class=\"form-signin\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            You are logged in as {{ app.user.username }}, <a href=\"{{ path('security_login') }}\">Logout</a>
        </div>
    {% endif %}

    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputMail\" class=\"sr-only\">Mail</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"mail\" id=\"inputMail\" class=\"form-control\" placeholder=\"Mail\" required autofocus>
    <label for=\"inputPassword\" class=\"sr-only\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Camille\\Desktop\\Nouveau dossier (2)\\SiteMMA\\templates\\security\\login.html.twig");
    }
}
