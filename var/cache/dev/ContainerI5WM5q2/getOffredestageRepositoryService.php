...
// Returns the private 'App\Repository\OffredestageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OffredestageRepository.php';

return $this->privates['App\\Repository\\OffredestageRepository'] = new \App\Repository\OffredestageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
