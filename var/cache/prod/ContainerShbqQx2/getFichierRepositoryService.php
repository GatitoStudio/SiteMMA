...
// Returns the private 'App\Repository\FichierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FichierRepository.php';

return $this->privates['App\\Repository\\FichierRepository'] = new \App\Repository\FichierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
