...
// Returns the private 'App\Repository\MigrationVersionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MigrationVersionsRepository.php';

return $this->privates['App\\Repository\\MigrationVersionsRepository'] = new \App\Repository\MigrationVersionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
